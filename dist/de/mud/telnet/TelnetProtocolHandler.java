...
public abstract class TelnetProtocolHandler {
    ...
    public final static String ID = "$Id: TelnetProtocolHandler.java,v 1.1.1.1 2003/12/08 02:45:50 mrdon Exp $";
    ...
    private final static byte TELOPT_BINARY = (byte) 0;
    /* binary mode */
    /**  Telnet option: echo text */
    private final static byte TELOPT_ECHO = (byte) 1;
    /* echo on/off */
    /**  Telnet option: sga */
    private final static byte TELOPT_SGA = (byte) 3;
    /* supress go ahead */
        ...
        for (i = 0; i < buf.length; i++) {
            switch (buf[i]) {
                ...
                case 10:// \n
                    ...
                    // FIXME: hack to force proper new lines
    ...
    /**
     *  Sets the cRLF attribute
     *
     *@param  xcrlf  The new cRLF value
     */

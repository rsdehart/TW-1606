...
public class SplashScreen extends JComponent
{
	...
	public SplashScreen()
	{
		...
		ImageIcon icon = new ImageIcon(cl.getResource("/icons/kokua-splash.png"));
        image = icon.getImage();
        
        setBackground(BG_COLOR);
        /*image = getToolkit().getImage(
			getClass().getResource("/icons/kokua-splash.png"));
        System.out.println("image:"+image+" resource:"+getClass().getResource("/icons/kokua-splash.png"));

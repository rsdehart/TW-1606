...
import org.twdata.TW1606U.tw.gui.*;
import javax.swing.*;
import java.io.File;
...
import org.twdata.TW1606U.action.JHelpAction;
...
public class View extends WindowAdapter {
    ...
    public void load() {
        ...
        try {
          ...
          clipb = new Clipboard("org.twdata.TW1606U.gui.View");
        }
        
        // intialize help
        JHelpAction.startHelpWorker("docs/KokuaReferenceLibrary.hs");
    }
    ...
    public void windowClosing(WindowEvent e) {
        org.twdata.TW1606U.action.Action exit = actionManager.getAction("exit");
        exit.invoke();
    }

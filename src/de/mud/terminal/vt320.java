...
public abstract class vt320 extends VDUBuffer implements VDUInput {
   ...
   * $Id: vt320.java,v 1.1.1.1 2003/12/08 02:45:48 mrdon Exp $
   */
  public final static String ID = "$Id: vt320.java,v 1.1.1.1 2003/12/08 02:45:48 mrdon Exp $";
  ...
  public String getString(int c, int l, int len) {
  ...
  {
     deleteArea(0,0,width - 1, height - 1);
